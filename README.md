...
**Project**: dashvibe-fun-folio 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: smal mobile freindly dashboard fun theme 
...
```sh
git clone https://github.com/GPT-Engineer-App/dashvibe-fun-folio.git
cd dashvibe-fun-folio
npm i
